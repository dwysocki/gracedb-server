    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eventlogs', models.ManyToManyField(to='events.EventLog')),
            ],
        ),
        migrations.CreateModel(
            name='VOEvent',
        ...
        migrations.AddField(
            model_name='event',
            name='labels',
            field=models.ManyToManyField(through='events.Labelling', to='events.Label'),
        ),
        migrations.AddField(
            model_name='event',
            name='pipeline',
        ...
        migrations.AddField(
            model_name='event',
            name='search',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='events.Search'),
        ),
        migrations.AddField(
            model_name='event',
            name='submitter',
        ...
        migrations.AddField(
            model_name='emobservation',
            name='group',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='events.EMGroup'),
        ),
        migrations.AddField(
            model_name='emobservation',
            name='submitter',
        ...
        migrations.AddField(
            ...
            name='observation',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='events.EMObservation'),
        ),
        migrations.AddField(
