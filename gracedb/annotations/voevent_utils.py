...
PACKET_TYPES = {
    VOEventBase.VOEVENT_TYPE_PRELIMINARY: (150, 'IGWN_PRELIMINARY'),
    VOEventBase.VOEVENT_TYPE_INITIAL: (151, 'IGWN_INITIAL'),
    VOEventBase.VOEVENT_TYPE_UPDATE: (152, 'IGWN_UPDATE'),
    VOEventBase.VOEVENT_TYPE_RETRACTION: (164, 'IGWN_RETRACTION'),
    VOEventBase.VOEVENT_TYPE_EARLYWARNING: (163, 'IGWN_EARLY_WARNING'),
}
