...
ROBOTS = [
        {
            'username' : 'mediumlatencygrbcron',
            'first_name' : '',
            'last_name' : 'Nathan Ormsby',  # Note that the last_name acts as a display
            'email' : 'nathan.ormsby.19@cnu.edu',
            'dns' : [
                "/DC=org/DC=cilogon/C=US/O=LIGO/OU=Robots/CN=runners.ligo.uwm.edu/CN=mediumlatencygrbcron/CN=Nathan Ormsby/CN=UID:nathan.ormsby.robot",
            ]
        },
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ligoauth', '0074_dqrtaskdev_robot'),
    ]
