...
ROBOTS = [
        {
            'username' : 'mly.robot',
            'first_name' : '',
            'last_name' : 'MLy Pipeline',  # Note that the last_name acts as a display
            'email' : 'kyle.willetts@ligo.org',
            'dns' : [
                "/DC=org/DC=cilogon/C=US/O=LIGO/OU=Robots/CN=mly.ligo.org/CN=mly/CN=Kyle Willetts/CN=UID:kyle.willetts.robot",
            ]
        },
]
