...
ROBOTS = [
        {
            'username' : 'dqr-task-dev',
            'first_name' : '',
            'last_name' : 'Joe Areeda',  # Note that the last_name acts as a display
            'email' : 'joe@areeda.com',
            'dns' : [
                "/DC=org/DC=cilogon/C=US/O=LIGO/OU=Robots/CN=dqr-dev.ligo.caltech.edu/CN=dqr-task-dev/CN=Joseph Areeda/CN=UID:joseph.areeda.robot",
            ]
        },
]
