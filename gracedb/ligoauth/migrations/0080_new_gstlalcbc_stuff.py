...
ROBOTS = [
        {
            'username' : 'gstlalcbc_icds',
            'first_name' : '',
            'last_name' : 'GstLal CBC at ICDS',  # Note that the last_name acts as a display
            'email' : 'rebecca.ewing@LIGO.org',
            'dns' : [
                "/DC=org/DC=cilogon/C=US/O=LIGO/OU=Robots/CN=comp-hd-001.gwave.ics.psu.edu/CN=gstlalcbc_icds/CN=Rebecca Ewing/CN=UID:rebecca.ewing.robot",
            ]
        },
]

UPLOADERS = ['gstlalcbc_icds',
             'rebecca.ewing@LIGO.ORG',
             'takuya.tsutsui@LIGO.ORG',]
