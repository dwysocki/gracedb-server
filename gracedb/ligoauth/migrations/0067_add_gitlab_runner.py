...
ROBOTS = [
        {
            ...
            'first_name' : '',
            'last_name' : 'Gitlab CI Runner',  # Note that the last_name acts as a display
            'email' : 'alexander.pace@ligo.org',
            'dns' : [
                "/DC=org/DC=cilogon/C=US/O=LIGO/OU=Robots/CN=runners.ligo.uwm.edu/CN=gitlab.gracedb/CN=Alexander Pace/CN=UID:alexander.pace.robot",
            ]
        },
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ligoauth', '0066_add_more_spiir_certs'),
    ]
