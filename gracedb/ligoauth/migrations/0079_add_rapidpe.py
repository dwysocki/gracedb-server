...
ROBOTS = [
        {
            'username' : 'rapidpe',
            'first_name' : '',
            'last_name' : 'RapidPE',  # Note that the last_name acts as a display
            'email' : 'daniel.wysocki@ligo.org',
            'dns' : [
                "/DC=org/DC=cilogon/C=US/O=LIGO/OU=Robots/CN=runners.ligo.uwm.edu/CN=gitlab.rapidpe-rift/CN=Daniel Wysocki/CN=UID:daniel.wysocki.robot",
            ]
        },
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ligoauth', '0078_gwskynet_account'),
    ]
