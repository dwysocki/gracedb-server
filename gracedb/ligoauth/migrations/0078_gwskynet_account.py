...
ROBOTS = [
        {
            'username' : 'gwskynet',
            'first_name' : '',
            'last_name' : 'GWSkyNet',  # Note that the last_name acts as a display
            'email' : 'manleong.chan@LIGO.org',
            'dns' : [
                "/DC=org/DC=cilogon/C=US/O=LIGO/OU=Robots/CN=ldas-pcdev.ligo.caltech.edu/CN=GWSkyNet/CN=Manleong Chan/CN=UID:manleong.chan.robot",
            ]
        },
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ligoauth', '0077_add_another_pycbc_cert'),
    ]
