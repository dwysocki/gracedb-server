...
ACCOUNT = {
    'name': 'gstlalcbc',
    'new_cert': '/DC=org/DC=cilogon/C=US/O=LIGO/OU=Robots/CN=submit.nemo.uwm.edu/CN=gstlalcbc_online_nemo_robot/CN=Amanda Baylor/CN=UID:amanda.baylor.robot',
}
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ligoauth', '0094_add_another_cwb_cert'),
    ]
