...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'gracedb_embbeventlog', (
            ...
            ('facility', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gracedb.EMFacility'])),
            ('footprintID', self.gf('django.db.models.fields.CharField')(max_length=200, null=True)),
            ...
            ('extra_info_dict', self.gf('django.db.models.fields.TextField')(null=True)),
        ))
        ...
        # Adding model 'EMFacility'
        db.create_table(u'gracedb_emfacility', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200)),
            ('shortName', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20)),
            ('liason', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'gracedb', ['EMFacility'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'EMFacility'
        db.delete_table(u'gracedb_emfacility')
    ...
    models = {
        ...
        u'gracedb.embbeventlog': {
            ...
            'extra_info_dict': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'facility': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['gracedb.EMFacility']"}),
            'footprintID': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True'}),
