# supports: https://git.ligo.org/computing/gracedb/server/-/issues/350
...
PP_LIST = [
    {
        'pipeline': 'GWAK',
        'usernames': [
            'katya.govorkova@ligo.org',
            'erik.katsavounidis@ligo.org',
            'eric.moreno@ligo.org',
            'ryan.raikman@ligo.org',
            'gwak-scitoken',
            'emfollow',
        ]
    },
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('guardian', '0024_add_more_chime_uploaders'),
