...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'gracedb_embbeventlog', 'footprintID', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'EMBBEventLog.comment'
        db.alter_column(u'gracedb_embbeventlog', 'comment', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'EMBBEventLog.extra_info_dict'
        db.alter_column(u'gracedb_embbeventlog', 'extra_info_dict', self.gf('django.db.models.fields.TextField')(default=''))

    def backwards(self, orm):

        # Changing field 'EMBBEventLog.footprintID'
        db.alter_column(u'gracedb_embbeventlog', 'footprintID', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'EMBBEventLog.comment'
        db.alter_column(u'gracedb_embbeventlog', 'comment', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'EMBBEventLog.extra_info_dict'
        db.alter_column(u'gracedb_embbeventlog', 'extra_info_dict', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        u'gracedb.embbeventlog': {
            ...
            'facility': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['gracedb.EMFacility']"}),
        ...
        u'gracedb.emfacility': {
            'Meta': {'object_name': 'EMFacility'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'liason': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
